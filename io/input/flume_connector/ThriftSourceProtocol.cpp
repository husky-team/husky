...
Status::type ThriftSourceProtocolClient::recv_appendBatch() {
    ...
    throw ::apache::thrift::TApplicationException(::apache::thrift::TApplicationException::MISSING_RESULT,
                                                  "appendBatch failed: unknown result");
}

bool ThriftSourceProtocolProcessor::dispatchCall(::apache::thrift::protocol::TProtocol* iprot,
...
void ThriftSourceProtocolProcessor::process_append(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot,
...
void ThriftSourceProtocolProcessor::process_appendBatch(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot,
...
::boost::shared_ptr<::apache::thrift::TProcessor> ThriftSourceProtocolProcessorFactory::getProcessor(
