...
int _kStatusValues[] = {Status::OK, Status::FAILED, Status::ERROR, Status::UNKNOWN};
const char* _kStatusNames[] = {"OK", "FAILED", "ERROR", "UNKNOWN"};
const std::map<int, const char*> _Status_VALUES_TO_NAMES(::apache::thrift::TEnumIterator(4, _kStatusValues,
                                                                                         _kStatusNames),
                                                         ::apache::thrift::TEnumIterator(-1, NULL, NULL));

ThriftFlumeEvent::~ThriftFlumeEvent() throw() {}

void ThriftFlumeEvent::__set_headers(const std::map<std::string, std::string>& val) { this->headers = val; }

void ThriftFlumeEvent::__set_body(const std::string& val) { this->body = val; }
...
uint32_t ThriftFlumeEvent::write(::apache::thrift::protocol::TProtocol* oprot) const {
    ...
    xfer += oprot->writeFieldBegin("headers", ::apache::thrift::protocol::T_MAP, 1);
    {
        xfer += oprot->writeMapBegin(::apache::thrift::protocol::T_STRING, ::apache::thrift::protocol::T_STRING,
                                     static_cast<uint32_t>(this->headers.size()));
